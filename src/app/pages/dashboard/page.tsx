  ...
  return (
    <div className='w-full bg-bgColor font-ShPinscher'>
      ...
      <div className='w-full flex flex-col justify-between items-center gap-20'>
        ...
        <p className='text-borderYellow text-title text-center'>CHECK OUT THE <Link href='dashboard/kongzdao' className='text-white underline'>KONGZ DAO</Link>  PAGE FOR THE LATEST UPDATES ON THE PROJECT!</p>
