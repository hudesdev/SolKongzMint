...
export default function Home(params) {
    console.log('params -->', params.params.url);
    ...
    return (
        ...
        {/* --------------------------------- Header --------------------------------- */}
            ...
            <div className='w-full flex flex-col justify-center items-center gap-20 pb-14 mt-12'>
                <div className='w-full md:w-1/3 border-[6px] rounded-2xl border-borderYellow bg-bgColor flex flex-col gap-4 items-center p-4'>
                    ...
                    <div className = "relative">
                        <img src = {assets[parseInt(params.params.url)].url} alt="no image" className = "w-[550px]" />
